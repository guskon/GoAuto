        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Generation = table.Column<string>(type: "varchar(50)", unicode: false, maxLength: 50, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Positives = table.Column<string>(type: "varchar(50)", unicode: false, maxLength: 50, nullable: false),
                    Negatives = table.Column<string>(type: "varchar(50)", unicode: false, maxLength: 50, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    FkReviewId = table.Column<int>(type: "int", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Responses_Reviews_FkReviewId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Responses_FkReviewId",
                table: "Responses",
                column: "FkReviewId");

            migrationBuilder.CreateIndex(
                name: "IX_Reviews_FkCarId",
                table: "Reviews",
                column: "FkCarId");
        }
