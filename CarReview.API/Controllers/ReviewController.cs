...
namespace CarReview.API.Controllers
{
    ...
    public class ReviewController : Controller
    {
        ...
        public ReviewController(CarReviewDbContext context, IMapper mapper)
        {
            _context = context;
            _mapper = mapper;
        }
        ...
        public async Task<IActionResult> Create(CreateReviewDTO newReview)
        {
            ...
            {
                var car = await _context.Cars.FirstOrDefaultAsync<Car>(x => x.Id.Equals(newReview.CarId));
                ...
                var user = await _context.Users.FirstOrDefaultAsync<User>(x => x.Id.Equals(newReview.UserId));
        ...
        public async Task<IActionResult> GetResponsesResult(int userId)
        {
            ...
            var user = await _context.Users.FirstOrDefaultAsync<User>(x => x.Id.Equals(userId));
            ...
            var reviews = await _context.Reviews.Where(x => x.FkUserId.Equals(userId)).ToListAsync();
        ...
        public async Task<IActionResult> GetReviewCount(int id)
        {
            ...
            var user = await _context.Users.FirstOrDefaultAsync<User>(x => x.Id.Equals(id));
            ...
            var reviews = await _context.Reviews.Where(x => x.FkUserId.Equals(id)).ToListAsync();
